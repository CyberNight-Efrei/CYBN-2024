...
"Reverse/The_Ugandan_Labyrinth/chall/build_docker.sh"
"Reverse/M30W_Bot/build_docker.sh"
"Minecraft/BGM/nc-frontend/build_docker.sh"
"System/Escabot/docker/build_docker.sh"
"System/Marche-pied/docker/build_docker.sh"
"System/Echelle/docker/build_docker.sh"
"Web/Ouaib pas simple/src/web/build_docker.sh"
"Web/Ouaib pas simple/src/bot/build_docker.sh"
...
do
    ...
    sudo bash $(basename "$script") -r || { echo "Failed to run $script"; exit 1; }
